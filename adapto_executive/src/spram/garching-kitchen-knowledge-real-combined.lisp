...
(defun generate-stpr-library ()
  (make-instance 'stpr-library
    :stpr-list (list 
                ...
                (generate-prepare-table-plan)
                (generate-clean-table-plan)
...
(defun generate-prepare-table-plan ()
  (make-instance 'stpr :st-list (list (make-instance 'timed-location
                                        :location-label 'oven
                                        :duration 1.5
                                        :object-labels '(cornflakes quark))
                                      (make-instance 'timed-location
                                        :location-label 'table
                                        :duration 3
                                        :object-labels '(cornflakes quark))
                 ...
                 :plan-length 8 
                 :name 'prepare-table-plan
                 :duration 150
                 :short-name 'ST))

(defun generate-clean-table-plan ()
  (make-instance 'stpr :st-list (list (make-instance 'timed-location
                                        :location-label 'table
                                        :duration 3
                                        :object-labels '(cornflakes quark))
